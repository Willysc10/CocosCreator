...
#[derive(Debug)]
pub struct CocosCreatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CocosCreatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CocosCreator processing");
    
    let mut processor = CocosCreatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CocosCreatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CocosCreatorProcessor::new(false);
